...
const UploadProduct = () => {
    ...
    const shellerId = JSON.parse(localStorage.getItem('user_Details'))._id;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = { productName, image: imgURL, price, description, category , shellerId };
                ...
                <div>
                    ...
                    <div className="mt-2">
                        ...
                        >
                            ...
                            <option value="tv-appliance">TV & Appliances</option>
